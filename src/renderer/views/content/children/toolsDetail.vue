                  ...
                  <div class="context">
                    <el-form :inline="true" label-width="72px">
                      ...
                      <el-form-item label="项目名称" >
                        <el-input v-model="formData.projectName" size="small" type="text"></el-input>
                      </el-form-item>
                      <!-- 选择文件 -->
                  ...
                  <div class="context">
                    <el-form  label-width="116px">
                      ...
                      <el-form-item label="选择用于作图的列">
                        <el-input size="small" type="text" v-model.trim="formData.columns" placeholder="如2,3,6,9"></el-input>
                      </el-form-item>
                    </el-form>
                        ...
                        <el-tab-pane label="输入数字" name="text">
                            <el-form  label-width="110px">
                              ...
                              <el-form-item label="作图使用前(行)">
                                <el-input size="small" v-model.trim="formData.beforeRow" placeholder="默认选择所有行进行聚类分析"></el-input>
                              </el-form-item>
                          </el-form>
                        </el-tab-pane>
                  ...
                  <div class="context">
                    ...
                    <el-form :inline="true">
                      <el-form-item label="字体大小">
                        <el-input size="small" type="number" v-model="drawOptions.fontSize" placeholder="请输入字体大小"></el-input>
                      </el-form-item>
                      <el-form-item label="格子的长度*高度">
                        <el-input size="small" type="text" v-model="drawOptions.cubeSize" placeholder="如20*12"></el-input>
                      </el-form-item>
                      ...
                      <el-form-item label="任务完成后发邮件通知我">
                        <el-checkbox-group v-model="drawOptions.email">
